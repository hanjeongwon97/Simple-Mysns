		...
		<div class="container1">
			...
			<section id="footer-outer-block">
					<aside class="footer-segment">
							<h4>About</h4>
								<ul>
									<li><a href="https://github.com/hanjeongwon97/Simple-mysns#simple-mysns">About My Simple SNS</a></li>
					...
					<aside class="footer-segment">
							<h4>Java Web Programming</h4>
								<ul>
									<li><a href="https://www.hanbit.co.kr/store/books/look.php?p_code=B8785158105">Book Information</a></li>
									<li><a href="https://www.hanbit.co.kr/index.html">Table of contents</a></li>
									<li><a href="https://www.hanbit.co.kr/index.html">Book History</a></li>
								</ul>
